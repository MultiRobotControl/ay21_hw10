...
plot(rabbit_ts.Data(:,1),rabbit_ts.Data(:,2),'r','LineWidth', 1); hold on
...
plot(odom3_ts.Time(:),dist3,'k','LineWidth', 1); 
...
plot(odom3_ts.Time(:), Udist3,'k','LineWidth',1);
